        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#">Project 01</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
$pasien1 = new Pasien();
$pasien1->tgl_lahir ='2001-03-01';
$pasien1->nama ='Elsa';
$pasien1->gender ='P';
$pasien1->tmp_lahir ='Bogor';

$pasien2 = new Pasien();
$pasien2->tgl_lahir ='2002-05-07';
$pasien2->nama ='Akmal';
$pasien2->gender ='L';
...
?>
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      <button name="submit" type="submit" class="btn btn-primary">Cek BMI</button>
    </div>
  </div>
</form>
<br>
